...
const Settings = () => {
  ...
  return (
    <div className="flex-1 flex items-center justify-center bg-linear-to-br from-gray-50 to-gray-100 md:p-4">
      <div className="w-full md:max-w-2xl bg-white md:rounded-2xl shadow-xl p-2 sm:p-6 md:p-8 overflow-y-auto">
        {/* Header */}
